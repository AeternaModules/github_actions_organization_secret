variable "actions_organization_secrets" {
  description = <<EOT
Map of actions_organization_secrets, attributes below
Required:
    - secret_name
    - visibility
Optional:
...
EOT
  ...
  # --- Unconfirmed validation candidates, derived from github_actions_organization_secret's provider source ---
