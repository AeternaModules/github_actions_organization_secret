output "actions_organization_secrets_id" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.id if v.id != null && length(v.id) > 0 }
}
output "actions_organization_secrets_created_at" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.created_at if v.created_at != null && length(v.created_at) > 0 }
}
output "actions_organization_secrets_destroy_on_drift" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.destroy_on_drift if v.destroy_on_drift != null }
}
output "actions_organization_secrets_encrypted_value" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.encrypted_value if v.encrypted_value != null && length(v.encrypted_value) > 0 }
  sensitive   = true
}
output "actions_organization_secrets_key_id" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.key_id if v.key_id != null && length(v.key_id) > 0 }
}
output "actions_organization_secrets_plaintext_value" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.plaintext_value if v.plaintext_value != null && length(v.plaintext_value) > 0 }
  sensitive   = true
}
output "actions_organization_secrets_remote_updated_at" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.remote_updated_at if v.remote_updated_at != null && length(v.remote_updated_at) > 0 }
}
output "actions_organization_secrets_secret_name" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.secret_name if v.secret_name != null && length(v.secret_name) > 0 }
}
output "actions_organization_secrets_selected_repository_ids" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.selected_repository_ids if v.selected_repository_ids != null && length(v.selected_repository_ids) > 0 }
}
output "actions_organization_secrets_updated_at" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.updated_at if v.updated_at != null && length(v.updated_at) > 0 }
}
output "actions_organization_secrets_value" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.value if v.value != null && length(v.value) > 0 }
  sensitive   = true
}
output "actions_organization_secrets_value_encrypted" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.value_encrypted if v.value_encrypted != null && length(v.value_encrypted) > 0 }
  sensitive   = true
}
output "actions_organization_secrets_visibility" {
  ...
  value       = { for k, v in github_actions_organization_secret.actions_organization_secrets : k => v.visibility if v.visibility != null && length(v.visibility) > 0 }
}
